...
if __name__ == '__main__':
        ...
        gbc = GradientBoostingClassifier(learning_rate=0.01, n_estimators=4000, min_samples_leaf=20, max_features=9, subsample=0.7, random_state=10, min_samples_split =1200) #scored 1.08676 training time 806.268s
